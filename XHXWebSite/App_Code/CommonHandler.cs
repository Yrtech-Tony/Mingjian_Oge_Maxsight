...
public class CommonHandler
{
    ...
    public static void DBConnect()
    {
        ...
        if (conn == null)
        {
            ...
            conn.ConnectionString = "Provider=sqloledb;Data Source=.;Initial Catalog=Oge;user id=sa;pwd=mxT1@mfb;";
    ...
    public static DataSet query(string sql)
    {
        ...
        string ConnectionString = "Provider=sqloledb;Data Source=.;Initial Catalog=Oge;user id=sa;pwd=mxT1@mfb;";
