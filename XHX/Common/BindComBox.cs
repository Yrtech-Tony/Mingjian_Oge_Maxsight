   ...
   public static class BindComBox
    {
       ...
       public static void BindSubjectExamType(ComboBoxEdit combox)
       {
           ...
           subjectExamTypeList.Add(new SubjectExamType("D", "D卷"));
           subjectExamTypeList.Add(new SubjectExamType("E", "E卷"));
           subjectExamTypeList.Add(new SubjectExamType("F", "F卷"));
       ...
       public static void BindSubjectType(ComboBoxEdit combox)
       {
           ...
           subjectTypeList.Add(new SubjectTypeDto("SA", "流程演练"));
           subjectTypeList.Add(new SubjectTypeDto("SB", "人员和单据"));
           subjectTypeList.Add(new SubjectTypeDto("SC", "硬件"));
